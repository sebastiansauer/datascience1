...
```{r overfitting-prep-4-plots, echo = FALSE, include = FALSE}
...
```{r echo = FALSE, fig.cap = "Welches Modell (Teile C-E) passt am besten zu den Daten (Teil B)? Die 'wahre Funktion', der datengenerierende Prozess ist im Teil A dargestellt", out.width = "100%"}
