...
![Die Aufteilung der Daten im Falle mehrerer Modellkandidaten](img/resampling.svg){#fig-fig-analys-assess-test}
...
Wie man sieht, streuen die $v=10$ Faltungen in ihrere Modellgüte, s. @fig-cv-rmse.
...
#
#| fig-subcap:
#|   - "Streuung mit v=10, r=1 CV"
#|   - "Streuung mit v=10, r=5 CV"
...
Abbildung @fig-nnoverfit aus [diesem Kapitel von](https://www.tmwr.org/tuning.html#overfitting-bad) @silge_tidy_2022 stellt exemplarisch dar,
