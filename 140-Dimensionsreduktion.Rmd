...
```{r redundpred, fig.cap = "Vorhersage von Gewicht mit mehreren hochkorrelierten Prädiktoren"}
nomnoml::nomnoml(
  "[Armlänge] -> [Gewicht]
  [Beinlänge] -> [Gewicht]
  [Handlänge] -> [Gewicht]
...
```{r curse1, fig.cap = "Illustration des Fluchs der Dimension"}
...
```{r curse2, fig.cap = "Je mehr Dimensionen, desto weniger Daten pro Einheit", out.width="50%"}
...
```{r pca1, fig.cap = "Zwei korrelierte, metrische Variablen",  out.width="33%"}
...
```{r pca2, fig.cap = "Zwei korrelierte, metrische Variablen", out.width="33%"}
...
```{r pca3, fig.cap ="Die Hauptkomponente maximiert die Varianz"}
