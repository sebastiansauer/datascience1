...
![Verlauf des Strafterms bei der L2-Norm](img/l2-penalty.png){#fig-l2-penalty}
...
![Verlauf des Strafterms bei der L1-Norm, Bildquelle: Rhys, 2020](img/l1-penalty.png){#fig-l1-penalty}
