...
```{r bag, fig.cap = "Bagging schematisch illustriert", echo = FALSE}
nomnoml::nomnoml(
  "
...
```{r rf1, fig.cap = "Zufallswälder durch Ziehen mit Zurücklegen (zmz) und Ziehen ohne Zurücklegen (ZoZ)", out.width = "100%", echo = FALSE}
nomnoml::nomnoml("
#direction:down
...
```{r stump, fig.cap = "Ein Baumstumpf bei AdaBoost", echo = FALSE}
nomnoml::nomnoml(
  "#direction: topdown
  [root] -> [leaf1]
  [root] -> [leaf2]
...
```{r exs-chap11, child = "Aufgaben/Thema11-Loesungen1.markdown", results='asis', eval = FALSE}
