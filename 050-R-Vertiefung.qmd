...
course_dates_file <- "https://raw.githubusercontent.com/sebastiansauer/datascience1/sose22/course-dates.yaml"
```
...
```{r echo = TRUE, eval = FALSE}
content_file <- "https://raw.githubusercontent.com/sebastiansauer/datascience1/sose22/_modul-ueberblick.yaml"
```
