...
chapter_start_sections(i = NULL, title = "tidymodels")
```
...
```{r train-test-pie, echo = FALSE, fig.align="center", out.height="200px"}
x <- c(80, 20)
x_lab <- c("Train", "Test")
pie(x, x_lab)
```
...
```{r tidymodels-def, echo = FALSE, fig.cap = "Definition eines Models in tidymodels", out.width="100%"}
d <- 
"#direction: leftright
[Modell|
  [type (Algorithmus)|
