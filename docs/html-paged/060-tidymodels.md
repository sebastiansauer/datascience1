...
```{=html}
<div id="htmlwidget-224e1c0956bf260aa4cb" style="width:100%;height:300px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-224e1c0956bf260aa4cb">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n#direction: leftright\n[Modell|\n  [type (Algorithmus)|\n    [Regression] \n    [Neuronale Netze] \n    [...]\n  ]  \n  [engine (Implementierung)|\n    [lm]\n    [stan_glm]\n    [...]\n  ]\n  [mode (modus)|\n    [regression]\n    [classification]\n  ]\n  \n]\n","svg":false,"png":null},"evals":[],"jsHooks":[]}</script>
```
...
## -1.02606 -0.09473 -0.01515  0.09992  0.57756 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -311.3112    14.4112  -21.60   <2e-16 ***
## Longitude     -2.0566     0.1301  -15.81   <2e-16 ***
## Latitude       2.9487     0.1806   16.33   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.161 on 2339 degrees of freedom
## Multiple R-squared:  0.1796,	Adjusted R-squared:  0.1789 
## F-statistic: 255.9 on 2 and 2339 DF,  p-value: < 2.2e-16
```
...
##   <chr>          <dbl>     <dbl>     <dbl>    <dbl>
## 1 (Intercept)  -311.      14.4       -21.6 1.63e-94
## 2 Longitude      -2.06     0.130     -15.8 1.38e-53
## 3 Latitude        2.95     0.181      16.3 7.57e-57
```
...
## 1     0.180         0.179 0.161      256. 3.04e-101     2   956. -1904. -1881.
...
```{=html}
<div id="htmlwidget-3f537331e3ccf94eb520" style="width:100%;height:500px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-3f537331e3ccf94eb520">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n\n[Workflow|\n  [preprocessing|\n   Vorverarbeitung;\n   Imputation;\n   Transformation;\n   Prädiktorwahl\n   AV-Wahl\n   ...\n  \n  ]\n  [fitting |\n    Modell berechnen\n    ...\n  ]\n  [postprocessing|\n    Grenzwerte für Klass. festlegen\n    ...\n  ]\n]\n","svg":false,"png":null},"evals":[],"jsHooks":[]}</script>
```
...
## 3 train/test split  5.27    20       5.32 Preprocessor1_Model1
## 4 train/test split  5.26    23       5.33 Preprocessor1_Model1
## 5 train/test split  5.25    26       5.15 Preprocessor1_Model1
```
...
```{=html}
<div id="cojwgkeltt" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#cojwgkeltt .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#cojwgkeltt .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#cojwgkeltt .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#cojwgkeltt .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#cojwgkeltt .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#cojwgkeltt .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#cojwgkeltt .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#cojwgkeltt .gt_from_md > :first-child {
  margin-top: 0;
}

#cojwgkeltt .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#cojwgkeltt .gt_row_group_first td {
  border-top-width: 2px;
}

#cojwgkeltt .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#cojwgkeltt .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #D3D3D3;
}

#cojwgkeltt .gt_first_summary_row.thick {
  border-top-width: 2px;
}

#cojwgkeltt .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cojwgkeltt .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#cojwgkeltt .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cojwgkeltt .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#cojwgkeltt .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#cojwgkeltt .gt_font_normal {
  font-weight: normal;
}

#cojwgkeltt .gt_font_bold {
  font-weight: bold;
}

#cojwgkeltt .gt_font_italic {
  font-style: italic;
}
...
#cojwgkeltt .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}

#cojwgkeltt .gt_slash_mark {
  font-size: 0.7em;
  line-height: 0.7em;
  vertical-align: 0.15em;
}

#cojwgkeltt .gt_fraction_numerator {
  font-size: 0.6em;
  line-height: 0.6em;
  vertical-align: 0.45em;
}

#cojwgkeltt .gt_fraction_denominator {
  font-size: 0.6em;
  line-height: 0.6em;
...
<td class="gt_row gt_left">standard</td>
<td class="gt_row gt_right">1.44 &times; 10<sup class='gt_super'>&minus;1</sup></td>
<td class="gt_row gt_left">Preprocessor1_Model1</td></tr>
  </tbody>
