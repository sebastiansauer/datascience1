...
```
##  [1] 27 28 33 35 78 79 83 84 87 89
```
...
```{=html}
<div id="htmlwidget-faca5d301a55804b48ba" style="width:100%;height:300px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-faca5d301a55804b48ba">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n#direction: leftright\n[Modell|\n  [type (Algorithmus)|\n    [Regression] \n    [Neuronale Netze] \n    [...]\n  ]  \n  [engine (Implementierung)|\n    [lm]\n    [stan_glm]\n    [...]\n  ]\n  [mode (modus)|\n    [regression]\n    [classification]\n  ]\n  \n]\n","svg":false},"evals":[],"jsHooks":[]}</script>
```
...
## -1.02377 -0.09745 -0.01558  0.09794  0.57707 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -308.6787    14.2732  -21.63   <2e-16 ***
## Longitude     -2.1003     0.1274  -16.48   <2e-16 ***
## Latitude       2.7887     0.1771   15.74   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.1585 on 2339 degrees of freedom
## Multiple R-squared:  0.177,	Adjusted R-squared:  0.1762 
## F-statistic: 251.4 on 2 and 2339 DF,  p-value: < 2.2e-16
```
...
##   <chr>          <dbl>     <dbl>     <dbl>    <dbl>
## 1 (Intercept)  -309.      14.3       -21.6 1.05e-94
## 2 Longitude      -2.10     0.127     -16.5 7.95e-58
## 3 Latitude        2.79     0.177      15.7 3.64e-53
```
...
## 1     0.177         0.176 0.159      251. 1.23e-99     2   992. -1976. -1953.
...
```{=html}
<div id="htmlwidget-31f2bed7113e9a7fdca8" style="width:100%;height:500px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-31f2bed7113e9a7fdca8">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n\n[Workflow|\n  [preprocessing|\n   Vorverarbeitung;\n   Imputation;\n   Transformation;\n   Prädiktorwahl\n   AV-Wahl\n   ...\n  \n  ]\n  [fitting |\n    Modell berechnen\n    ...\n  ]\n  [postprocessing|\n    Grenzwerte für Klass. festlegen\n    ...\n  ]\n]\n","svg":false},"evals":[],"jsHooks":[]}</script>
```
...
## 3 train/test split  5.22     3       5.24 Preprocessor1_Model1
...
```{=html}
<div id="kqvalirsxr" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#kqvalirsxr .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#kqvalirsxr .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#kqvalirsxr .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#kqvalirsxr .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#kqvalirsxr .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#kqvalirsxr .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#kqvalirsxr .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#kqvalirsxr .gt_from_md > :first-child {
  margin-top: 0;
}

#kqvalirsxr .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#kqvalirsxr .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kqvalirsxr .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#kqvalirsxr .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#kqvalirsxr .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#kqvalirsxr .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#kqvalirsxr .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#kqvalirsxr .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#kqvalirsxr .gt_font_normal {
  font-weight: normal;
}

#kqvalirsxr .gt_font_bold {
  font-weight: bold;
}

#kqvalirsxr .gt_font_italic {
  font-style: italic;
}
...
<td class="gt_row gt_right">1.71 &times; 10<sup class='gt_super'>&minus;1</sup></td>
...
##   <chr>   <chr>          <dbl> <chr>               
## 1 rmse    standard      0.0880 Preprocessor1_Model1
