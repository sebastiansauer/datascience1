...
<div class="figure" style="text-align: center">
<img src="/Users/sebastiansaueruser/Google Drive/research/Publikationen/In_Arbeit/Statistik__21/images/cluster/distanz_crop.png" alt="Euklidischer Abstand wird mit der Regel von Pythagoras berechnet" width="70%" />
...
<div class="figure" style="text-align: center">
<img src="/Users/sebastiansaueruser/Google Drive/research/Publikationen/In_Arbeit/Statistik__21/images/cluster/pythagoras_crop.png" alt="Pythagoras aufgebohrt" width="70%" />
<p class="caption">(\#fig:pyth2)Pythagoras aufgebohrt</p>
</div>
...
## 
## Type of response variable: nominal
## Minimal misclassification: 0.1314554
## Best kernel: rectangular
## Best k: 3
```
...
```{=html}
<div id="xcpmdfjkko" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#xcpmdfjkko .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#xcpmdfjkko .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#xcpmdfjkko .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#xcpmdfjkko .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#xcpmdfjkko .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#xcpmdfjkko .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#xcpmdfjkko .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#xcpmdfjkko .gt_from_md > :first-child {
  margin-top: 0;
}

#xcpmdfjkko .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#xcpmdfjkko .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#xcpmdfjkko .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#xcpmdfjkko .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#xcpmdfjkko .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#xcpmdfjkko .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#xcpmdfjkko .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#xcpmdfjkko .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#xcpmdfjkko .gt_font_normal {
  font-weight: normal;
}

#xcpmdfjkko .gt_font_bold {
  font-weight: bold;
}

#xcpmdfjkko .gt_font_italic {
  font-style: italic;
}
...
```{=html}
<div id="mysoxnhvlv" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Helvetica Neue', 'Fira Sans', 'Droid Sans', Arial, sans-serif;
}
...
#mysoxnhvlv .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#mysoxnhvlv .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#mysoxnhvlv .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#mysoxnhvlv .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#mysoxnhvlv .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#mysoxnhvlv .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#mysoxnhvlv .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#mysoxnhvlv .gt_from_md > :first-child {
  margin-top: 0;
}

#mysoxnhvlv .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#mysoxnhvlv .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mysoxnhvlv .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#mysoxnhvlv .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#mysoxnhvlv .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#mysoxnhvlv .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#mysoxnhvlv .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#mysoxnhvlv .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#mysoxnhvlv .gt_font_normal {
  font-weight: normal;
}

#mysoxnhvlv .gt_font_bold {
  font-weight: bold;
}

#mysoxnhvlv .gt_font_italic {
  font-style: italic;
}
