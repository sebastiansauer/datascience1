...
```
##  [1]  2 27 28 30 31 32 35 78 79 83
```
...
```{=html}
<div id="htmlwidget-82053c79cdd3f92569a9" style="width:100%;height:300px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-82053c79cdd3f92569a9">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n#direction: leftright\n[Modell|\n  [type (Algorithmus)|\n    [Regression] \n    [Neuronale Netze] \n    [...]\n  ]  \n  [engine (Implementierung)|\n    [lm]\n    [stan_glm]\n    [...]\n  ]\n  [mode (modus)|\n    [regression]\n    [classification]\n  ]\n  \n]\n","svg":false},"evals":[],"jsHooks":[]}</script>
```
...
## -1.01981 -0.09569 -0.01661  0.09742  0.57544 
## 
## Coefficients:
##              Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -316.9330    14.4397  -21.95   <2e-16 ***
## Longitude     -2.1226     0.1289  -16.47   <2e-16 ***
## Latitude       2.9355     0.1793   16.37   <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.1602 on 2339 degrees of freedom
## Multiple R-squared:  0.1824,	Adjusted R-squared:  0.1817 
## F-statistic:   261 on 2 and 2339 DF,  p-value: < 2.2e-16
```
...
##   <chr>          <dbl>     <dbl>     <dbl>    <dbl>
## 1 (Intercept)  -317.      14.4       -21.9 3.02e-97
## 2 Longitude      -2.12     0.129     -16.5 9.89e-58
## 3 Latitude        2.94     0.179      16.4 4.32e-57
```
...
## 1     0.182         0.182 0.160      261. 5.00e-103     2   967. -1927. -1903.
...
```{=html}
<div id="htmlwidget-fca39195b6d248e64fc7" style="width:100%;height:500px;" class="nomnoml html-widget"></div>
<script type="application/json" data-for="htmlwidget-fca39195b6d248e64fc7">{"x":{"code":"\n#fill: #FEFEFF\n#lineWidth: 1\n#zoom: 4\n#direction: right\n\n\n[Workflow|\n  [preprocessing|\n   Vorverarbeitung;\n   Imputation;\n   Transformation;\n   Prädiktorwahl\n   AV-Wahl\n   ...\n  \n  ]\n  [fitting |\n    Modell berechnen\n    ...\n  ]\n  [postprocessing|\n    Grenzwerte für Klass. festlegen\n    ...\n  ]\n]\n","svg":false},"evals":[],"jsHooks":[]}</script>
```
...
##   <chr>            <dbl> <int>      <dbl> <chr>               
## 1 train/test split  5.27    15       5.33 Preprocessor1_Model1
## 2 train/test split  5.23    33       5.11 Preprocessor1_Model1
## 3 train/test split  5.32    37       5.58 Preprocessor1_Model1
## 4 train/test split  5.33    38       5.49 Preprocessor1_Model1
...
```{=html}
<div id="cfzntzfjjd" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>html {
...
#cfzntzfjjd .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#cfzntzfjjd .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#cfzntzfjjd .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
#cfzntzfjjd .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#cfzntzfjjd .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#cfzntzfjjd .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#cfzntzfjjd .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
#cfzntzfjjd .gt_from_md > :first-child {
  margin-top: 0;
}

#cfzntzfjjd .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#cfzntzfjjd .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cfzntzfjjd .gt_grand_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
#cfzntzfjjd .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#cfzntzfjjd .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#cfzntzfjjd .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#cfzntzfjjd .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#cfzntzfjjd .gt_sourcenotes {
  color: #333333;
  background-color: #FFFFFF;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#cfzntzfjjd .gt_font_normal {
  font-weight: normal;
}

#cfzntzfjjd .gt_font_bold {
  font-weight: bold;
}

#cfzntzfjjd .gt_font_italic {
  font-style: italic;
}
...
<td class="gt_row gt_left">standard</td>
<td class="gt_row gt_right">1.35 &times; 10<sup class='gt_super'>&minus;1</sup></td>
<td class="gt_row gt_left">Preprocessor1_Model1</td></tr>
  </tbody>
...
##   <chr>   <chr>          <dbl> <chr>               
## 1 rmse    standard      0.0841 Preprocessor1_Model1
## 2 rsq     standard      0.773  Preprocessor1_Model1
```
